...
#Получаем правильный падеж и число слова рубль
def currency(n):
    result = ''
...
n=int(input("Введите число от 1 до 9999\n"))#Получение числа от юзера
if 1 < n < 9999:#Проверка на корректность числа
    print(GetWordForm(n).capitalize(), currency(n))#вывод нужных слов
else:
